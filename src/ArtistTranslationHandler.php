...
/**
 * Defines the translation handler for artists.
 */
class ArtistTranslationHandler extends ContentTranslationHandler {
  ...
  public function entityFormAlter(array &$form, FormStateInterface $form_state, EntityInterface $entity) {
    ...
    if (isset($form['content_translation'])) {
      // We do not need to show these values on artist forms: they inherit the
      // basic artist property values.
